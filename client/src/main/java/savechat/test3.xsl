...
<!--     <xsl:variable name="owner" select="'mohamed'"/>-->
    <xsl:variable name="holder" select="/chathistory/@holder"/>
    <!--     <xsl:variable name="owner" select="'mohamed'"/>-->
    ...
    <xsl:template match="/*[1]">
        <html>
            ...
            <head>
               ...
               <h3> <xsl:value-of select="$holder"/></h3>
                <title>$holder</title>
                <style type="text/css">
            ...
            <body>
                ...
                <ol class="chat">
                    ...
                    <div><xsl:value-of select="/chathistory/Msg/to"/></div>
                     </xsl:for-each>
                                    <div class="msg">
                                        
                                            <p style="font-style: {fontFamily};
                                                       color:{fontColor};
                            ...
                            <xsl:otherwise>
                               ...
                               <div><xsl:value-of select="from"/></div>
                     <xsl:for-each select="/chathistory/Msg/to">
                    <div class="name"><xsl:value-of select="/chathistory/Msg/to"/></div>
                     </xsl:for-each>
                                    <div class="msg">
